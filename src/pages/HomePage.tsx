            ...
            {categories?.map((category) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-center group-hover:text-primary-600 transition-colors">
                    {category.charAt(0).toUpperCase() + category.slice(1)}
                  </h3>
                  <p className="text-center text-gray-600 text-sm mt-2">{info.description}</p>
                </Link>
              );
            })}
          </div>
